...
using AcqDealImportNProcessEngine;

namespace RightsU.SynMusicRightsValidation.ImportAcqNProcessHost
{
    public partial class SynMusicRights_ValidateAcqData : ServiceBase
    {
        Timer timer;
        int count;
        ...
        public SynMusicRights_ValidateAcqData()
        {
            InitializeComponent();
        }
        ...
        public void TimerElapsed(object sender, ElapsedEventArgs e)
        {
            ...
            try
            {
                ...
                AcqDealImportNProcessJob objAcqDealJob = new AcqDealImportNProcessJob();
