...
{
    public class FindRightsDuplication
    {
        ...
        public List<Right> CheckRightsDuplication(List<SynDealRightsEntity> acquisitionDealRightsEntities, SynDealRightsEntity currentRight)
        {
            objRightsList = new List<Right>();

            //List<SynDealRightsEntity> acquisitionDealRightsEntityNotDistinct = acquisitionDealRightsEntities.Where(a => a.OtherData.RightCode != musicRightsCode).ToList();

            //SynDealRightsEntity currentRight = acquisitionDealRightsEntities.Where(a => a.OtherData.RightCode == musicRightsCode).FirstOrDefault();

            foreach (var acquisitionDealRightsEntity in acquisitionDealRightsEntities)
            {
