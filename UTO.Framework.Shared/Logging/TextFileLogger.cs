...
namespace UTO.Framework.Shared.Logging
{
    public class TextFileLogger : ILogger
    {
        ...
        private string _stringExtension = ".txt";
        ...
        public TextFileLogger(int appId, string appName, IConfiguration configuration)
        {
        ...
        /// </summary>
        /// <param name="configuration"></param>
        public TextFileLogger(IConfiguration configuration)
        {
            _configuration = configuration;
                ...
                lock (filelocker)
                {
                    using (StreamWriter streamWriter = new StreamWriter(appFolderPath + _folderSeparator + DateTime.Now.ToString("ddMMMyyyy") + _stringExtension, true))
                    {
                        ...
                        if (ex != null)
                            ...
                            formattedMessage = String.Format("{0}\t{1}\t{2}\t{3}\t{4}", level.ToString(), appId, appName, message, DateTime.Now.ToString("ddMMMyyyy HH:mm:ss"));
